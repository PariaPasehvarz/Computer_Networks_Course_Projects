...
IN_PATH  = "dat/rtt_avg.dat"
OUT_PATH = "dat/rtt_avg_smooth.dat"
WINDOW = 10
...
def main():
    ...
    with open(OUT_PATH, "w") as f:
        f.write(f"# Smoothed RTT with {WINDOW}s moving average\n")
        f.write("# time  Tahoe_f1 Tahoe_f2 Reno_f1 Reno_f2 Vegas_f1 Vegas_f2   (ms)\n")
